...
public class BinglixinxiVO  implements Serializable {
	...
	public void setJiuzhenzhenshi(String jiuzhenzhenshi) {
		this.jiuzhenzhenshi = jiuzhenzhenshi;
	}
	
	/**
	 * 获取：就诊诊室
	 */
	public String getJiuzhenzhenshi() {
		return jiuzhenzhenshi;
	}
