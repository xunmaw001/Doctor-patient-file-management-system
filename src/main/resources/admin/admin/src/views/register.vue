<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">医患档案管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='huanzhe'" class="input-group">
			   <div class="label">患者账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.huanzhezhanghao" class="input" type="text" placeholder="患者账号">
			   </div>
			 </div> -->
			<el-form-item label="患者账号" class="input" v-if="tableName=='huanzhe'">
			  <el-input v-model="ruleForm.huanzhezhanghao" autocomplete="off" placeholder="患者账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='huanzhe'" class="input-group">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='huanzhe'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='huanzhe'">
			...
			<!-- <div v-if="tableName=='huanzhe'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.huanzhexingming" class="input" type="text" placeholder="患者姓名">
			   </div>
			 </div> -->
			<el-form-item label="患者姓名" class="input" v-if="tableName=='huanzhe'">
			  <el-input v-model="ruleForm.huanzhexingming" autocomplete="off" placeholder="患者姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='huanzhe'" class="input-group">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='huanzhe'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='huanzhe'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">医生账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yishengzhanghao" class="input" type="text" placeholder="医生账号">
			   </div>
			 </div> -->
			<el-form-item label="医生账号" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.yishengzhanghao" autocomplete="off" placeholder="医生账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">所属诊室</div>
			   <div class="input-container">
			     <input v-model="ruleForm.suoshuzhenshi" class="input" type="text" placeholder="所属诊室">
			   </div>
			 </div> -->
			<el-form-item label="所属诊室" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.suoshuzhenshi" autocomplete="off" placeholder="所属诊室"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
