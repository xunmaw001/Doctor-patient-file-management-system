<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="诊疗编号" prop="zhenliaobianhao">
            <el-input v-model="ruleForm.zhenliaobianhao" 
                placeholder="诊疗编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhenliaobianhao" label="诊疗编号" prop="zhenliaobianhao">
              <el-input v-model="ruleForm.zhenliaobianhao" 
                placeholder="诊疗编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="患者账号" prop="huanzhezhanghao">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.huanzhezhanghao" label="患者账号" prop="huanzhezhanghao">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生账号" prop="yishengzhanghao">
          <el-input v-model="ruleForm.yishengzhanghao" 
              placeholder="医生账号" clearable  :readonly="ro.yishengzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生账号" prop="yishengzhanghao">
              <el-input v-model="ruleForm.yishengzhanghao" 
                placeholder="医生账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属诊室" prop="suoshuzhenshi">
          <el-input v-model="ruleForm.suoshuzhenshi" 
              placeholder="所属诊室" clearable  :readonly="ro.suoshuzhenshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属诊室" prop="suoshuzhenshi">
              <el-input v-model="ruleForm.suoshuzhenshi" 
                placeholder="所属诊室" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="诊疗时间" prop="zhenliaoshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.zhenliaoshijian" 
                type="date"
                :readonly="ro.zhenliaoshijian"
                placeholder="诊疗时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhenliaoshijian" label="诊疗时间" prop="zhenliaoshijian">
              <el-input v-model="ruleForm.zhenliaoshijian" 
                placeholder="诊疗时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="诊疗内容" prop="zhenliaoneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhenliaoneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhenliaoneirong" label="诊疗内容" prop="zhenliaoneirong">
                    <span v-html="ruleForm.zhenliaoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	suoshuzhenshi : false,
	zhenliaoshijian : false,
	zhenliaoneirong : false,
      },
      ruleForm: {
        zhenliaobianhao: this.getUUID(),
        huanzhezhanghao: '',
        huanzhexingming: '',
        nianling: '',
        yishengzhanghao: '',
  ...
  created() {
	this.ruleForm.zhenliaoshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhenliaobianhao'){
            this.ruleForm.zhenliaobianhao = obj[o];
	    this.ro.zhenliaobianhao = true;
            continue;
          }
	    ...
	    this.ro.yishengxingming = true;
          ...
          if(o=='suoshuzhenshi'){
            this.ruleForm.suoshuzhenshi = obj[o];
	    this.ro.suoshuzhenshi = true;
            continue;
          }
          if(o=='zhenliaoshijian'){
            this.ruleForm.zhenliaoshijian = obj[o];
	    this.ro.zhenliaoshijian = true;
            continue;
          }
          if(o=='zhenliaoneirong'){
            this.ruleForm.zhenliaoneirong = obj[o];
	    this.ro.zhenliaoneirong = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.yishengzhanghao!=''&&json.yishengzhanghao){
		...
		if(json.suoshuzhenshi!=''&&json.suoshuzhenshi){
                this.ruleForm.suoshuzhenshi = json.suoshuzhenshi
	    		this.ro.suoshuzhenshi = true;
		}
        } else {
	...
	this.ruleForm.zhenliaoneirong = this.ruleForm.zhenliaoneirong.replace(reg,'../../../springboot7ld2o/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhenliaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhenliaoxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
