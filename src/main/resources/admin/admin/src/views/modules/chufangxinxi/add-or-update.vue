<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="处方单号" prop="chufangdanhao">
            <el-input v-model="ruleForm.chufangdanhao" 
                placeholder="处方单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chufangdanhao" label="处方单号" prop="chufangdanhao">
              <el-input v-model="ruleForm.chufangdanhao" 
                placeholder="处方单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="处方日期" prop="chufangriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.chufangriqi" 
                type="date"
                :readonly="ro.chufangriqi"
                placeholder="处方日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chufangriqi" label="处方日期" prop="chufangriqi">
              <el-input v-model="ruleForm.chufangriqi" 
                placeholder="处方日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="医嘱内容" prop="yizhuneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yizhuneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yizhuneirong" label="医嘱内容" prop="yizhuneirong">
                    <span v-html="ruleForm.yizhuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="处方信息" prop="chufangxinxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.chufangxinxi" label="处方信息" prop="chufangxinxi">
                    <span v-html="ruleForm.chufangxinxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.chufangriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='chufangdanhao'){
            this.ruleForm.chufangdanhao = obj[o];
	    this.ro.chufangdanhao = true;
            continue;
          }
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='chufangriqi'){
            this.ruleForm.chufangriqi = obj[o];
	    this.ro.chufangriqi = true;
            continue;
          }
          if(o=='yizhuneirong'){
            this.ruleForm.yizhuneirong = obj[o];
	    this.ro.yizhuneirong = true;
            continue;
          }
          if(o=='chufangxinxi'){
	...
	this.ruleForm.yizhuneirong = this.ruleForm.yizhuneirong.replace(reg,'../../../springboot7ld2o/upload');
	this.ruleForm.chufangxinxi = this.ruleForm.chufangxinxi.replace(reg,'../../../springboot7ld2o/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chufangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chufangxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
